...
To run tests, go to terminal and type
R -e "shiny::runTests()"

# Shiny App Testing using GitHub Actions

<!-- badges: start -->
[![run-tests](https://github.com/vmarutha/MDMAPR2/actions/workflows/run-tests.yaml/badge.svg)](https://github.com/vmarutha/MDMAPR2/actions/workflows/run-tests.yaml)
<!-- badges: end -->
